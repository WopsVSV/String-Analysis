...
namespace stranalysis.Core
{
    ...
    {
        /// <summary>
        /// Determines whether or not the assembly is managed
        /// </summary>
        public static AssemblyInfo GetAssemblyInfo(string fileName)
        {
            ...
            //Get KB
            info.SizeKB = (fs.Length / 1024).ToString() + " kb";
            ...
            if (dataDictionaryRVA[14] == 0) info.Type = "Unmanaged";
            else info.Type = "Managed";
